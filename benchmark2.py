...
sequential_merge = [0.001713, 0.013989, 0.096720, 1.046827]
sequential_quick = [0.000666, 0.005758, 0.064501, 2.228275]
openmp_merge     = [0.000690, 0.003547, 0.032811, 0.333276]
openmp_quick     = [0.000751, 0.003191, 0.032031, 1.304999]
mpi_merge        = [0.000502, 0.004471, 0.041358, 0.447858]
mpi_quick        = [0.000030, 0.001495, 0.012873, 0.126554]
...
def plot_execution_time():
    ...
    ax.legend()
    plt.tight_layout()
    plt.savefig("execution_time_bar2.png")
    plt.show()
...
def plot_efficiency():
    ...
    ax.legend()
    plt.tight_layout()
    plt.savefig("efficiency_bar2.png")
    plt.show()

# --------------- CSV Export ---------------

def save_to_csv(filename="metrics2.csv"):
